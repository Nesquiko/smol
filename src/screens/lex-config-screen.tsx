      ...
      <div class="flex flex-col w-full max-w-2xl items-center justify-center gap-12">
        <div class="w-full flex flex-col items-center justify-center gap-3">
          ...
          <p class="text-sm text-muted-foreground/60">
            Before continuing, choose how should the lexical analyser treat different types of errors.
          </p>
        </div>
            ...
            {(modeData: ErrorModeData) => (
              <Card
                ...
                classList={{
                  ...
                  "ring-transparent hover:ring-primary-300/30": props.lexErrorMode() !== modeData.mode,
                }}
                onClick={() => props.setLexErrorMode(props.lexErrorMode() === modeData.mode ? undefined : modeData.mode as LexErrorMode)}
              >
                <CardHeader>
